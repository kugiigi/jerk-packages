...
KeyPad {
    ...
    Column {
        ...
        Row {
            ...
            FlickCharKey {
                charlabel: symojiKey.state == "marks" ? ["ğ", "å", "ġ", "ǵ", "ǧ"] : ["–", "§", "¦", "ß", "⸘"]
                leaves: charlabel
            ...
            FlickCharKey {
                charlabel: symojiKey.state == "marks" ? ["ű", "ů", "ż", "ź", "ž"] : ["—", "ſ", "‽", "ı", "ð"]
                leaves: charlabel
        ...
        Row {
            ...
            FlickCharKey {
                charlabel: symojiKey.state == "marks" ? ["ø", "ŗ", "ṙ", "ŕ", "ř"] : ["„", "»", "‾", "«", "¿"]
                leaves: charlabel
            ...
            FlickCharKey {
                charlabel: symojiKey.state == "marks" ? ["ə", "ş", "ṡ", "ś", "š"] : ["…", "ª", "¨", "°", "¡"]
                leaves: charlabel

...
KeyPad {
    ...
    Column {
        ...
        Item {
            ...
            // ENH227 - Domains in period EN key
            // CharKey        { id: dotKey;      label: "."; shifted: "."; extended: ["?", "-", "_", "!", "+", "%","#","/"];  extendedShifted: ["?", "-", "_", "!", "+", "%","#","/"]; anchors.right: enterKey.left; height: parent.height; }
            CharKey        {id: dotKey;      label: "."; shifted: ".";
                extended: fullScreenItem.settings.replacePeriodExtendedDomainsEN ? [".com", ".co.uk", ".net", ".org", ".edu", ".gov", ".ac.uk"] : ["?", "-", "_", "!", "+", "%","#","/"];
                extendedShifted: fullScreenItem.settings.replacePeriodExtendedDomainsEN ? [".com", ".co.uk", ".net", ".org", ".edu", ".gov", ".ac.uk"] : ["?", "-", "_", "!", "+", "%","#","/"];

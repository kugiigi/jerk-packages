...
FocusScope {
    ...
    Component {
        ...
        Item {
            ...
            // Workaround fix in Noble/desktop where other pages are initially shown behind the first page
            visible: root.fullAppGridLast ? Math.abs(appGridIndex - swipeView.currentIndex) <= 1
                                          : Math.abs(appGridIndex + 1 - swipeView.currentIndex) <= 1

...
Item {
    ...
    property real contentTopMargin: shell.adjustForMiddleNotch && expanded && !inverted ? shell.deviceConfiguration.notchHeightMargin : 0
    // ENH095 - End
    ...
    Item {
        ...
        anchors.fill: parent
        // ENH002 - Notch/Punch hole fix
        /* right margin of the indicator icons */

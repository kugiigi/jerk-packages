    ...
    */
    ...
    Item {
        ...
        Rectangle {
            ...
            //                : shell.settings.useCustomPanelColor ? shell.settings.customPanelColor : theme.palette.normal.background
            color: {
                if (callHint.visible) {
                ...
                return shell.settings.useCustomPanelColor ? shell.settings.customPanelColor : theme.palette.normal.background
            }
            // ENH170 - End
            // ENH046 - End
            anchors {

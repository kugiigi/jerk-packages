...
Showable {
    ...
    property color panelColor: shell.settings.useCustomIndicatorPanelColor
                                    || shell.settings.useCustomIndicatorPanelOpacity ? Qt.hsla(customPanelColor.hslHue, customPanelColor.hslSaturation, customPanelColor.hslLightness, colorOpacity)
                : "#DA000000"
    // ENH166 - End
    // ENH111 - End

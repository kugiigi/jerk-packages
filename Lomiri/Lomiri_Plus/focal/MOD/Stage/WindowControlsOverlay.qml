...
Item {
    ...
    readonly property bool touchDragging: gestureArea.dragging
    readonly property point touchPoint: Qt.point(gestureArea.tp.x, gestureArea.tp.y)
    // ENH155 - End
    ...
    TouchGestureArea {
        id: gestureArea
        anchors.fill: parent
        // ENH160 - Enable 3 finger drag even with resize UI displayed
        z: overlay.z + 1
        // ENH160 - End

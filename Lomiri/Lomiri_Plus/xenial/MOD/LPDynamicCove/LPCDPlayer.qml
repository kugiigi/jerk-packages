...
LPDynamicCoveItem {
	...
	Rectangle {
        ...
        visible: playBackObj && playBackObj.canPlay
		x: 0
		y: {
	...
	ColumnLayout {
		...
		NumberAnimation {
			...
			target: textContainer
			property: "opacity"
			duration: nextPrevSwipe.dragging ? UbuntuAnimation.FastDuration : UbuntuAnimation.SleepyDuration
			from: 0
			to: 1
		}

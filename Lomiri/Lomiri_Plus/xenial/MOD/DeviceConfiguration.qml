...
QtObject {
    ...
    readonly property var priv: StateGroup {
        ...
        property bool fullyHideNotchInPortrait: (withNotch && shell.settings.fullyHideNotchInNative) || shell.hideTopPanel // (True) Full bar where the notch is will be blank space. (False) Indicator bar height is equal to notchHeightMargin

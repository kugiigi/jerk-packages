...
Item {
    ...
    property var currentItem: menuCircle.childAt(mouseArea.mouseX, mouseArea.mouseY - units.gu(6)) //item underneath cursor
	...
	Item {
		...
		anchors.fill: parent
		visible: opacity > 0
        opacity: circularMenu.mouseArea.pressed ? 1: 0

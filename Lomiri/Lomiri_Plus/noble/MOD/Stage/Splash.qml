...
Item {
    ...
    StyledItem {
        ...
        readonly property var fakeTheme: QtObject {
            ...
            property Palette palette: Qt.createQmlObject("import QtQuick 2.15;\
    ...
    Image {
        ...
        cache: false
        clip: true
        // ENH200 - Splash screen in windowed mode
        width: shell.isWindowedMode ? Math.min(parent.width * 0.9, units.gu(40)) : sourceSize.width
        height: shell.isWindowedMode ? (sourceSize.height / sourceSize.width) * width : sourceSize.height
        // ENH200 - End
    }

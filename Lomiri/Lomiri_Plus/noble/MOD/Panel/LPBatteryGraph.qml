...
Item {
    ...
    readonly property real lastFullChargeTimeDifference: shell.batteryTracking ? now - shell.batteryTracking.lastFullChargeDatetime : 0
    readonly property string lastFullChargeFromTrackingLabel: shell.batteryTracking && shell.batteryTracking.lastFullChargeDatetime > 0 && lastFullChargeTimeDifference > 0

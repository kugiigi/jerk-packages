...
LPClockCircle {
    ...
    Image {
        ...
        Behavior on rotation { enabled: animateRotation; LomiriNumberAnimation { duration:LomiriAnimation.FastDuration } }
    }
    ...
    Image {
        ...
        smooth: true
        source: Theme.name == "Lomiri.Components.Themes.Ambiance" ? "graphics/Minute_Hand.png" : "graphics/Minute_Hand_White.png"
        asynchronous: true
        fillMode: Image.PreserveAspectFit
        // notLocalizedDateTimeString.split(":")[4] is minutes
        // notLocalizedDateTimeString.split(":")[5] is seconds

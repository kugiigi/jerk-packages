...
FocusScope {
    ...
    BackgroundBlur {
        ...
        anchors.topMargin: root.inverted ? -root.topMarginBlur : -(root.topPanelHeight + root.topMarginBlur)
        ...
        // ENH031 - Blur behavior in Drawer
                          ...
                          height - root.topPanelHeight - root.topMarginBlur)
      // ENH031 - End

    ...
    Component {
        ...
        Page {
            ...
            Loader {
                ...
                active: root.identifier == "ayatana-indicator-session" && !shell.showingGreeter
                asynchronous: true
                anchors {
                    top: parent.top
                    left: parent.left
                ...
                sourceComponent: Menus.BaseLayoutMenu {
            ...
            ListView {
                ...
                anchors {
                    // ENH046 - Lomiri Plus Settings
                    // top: page.isSubmenu ? backLabel.bottom : parent.top
                    top: page.isSubmenu ? backLabel.bottom : lpSettings.active ? lpSettings.bottom : parent.top
                    // ENH046 - End
                    left: parent.left
                    right: parent.right

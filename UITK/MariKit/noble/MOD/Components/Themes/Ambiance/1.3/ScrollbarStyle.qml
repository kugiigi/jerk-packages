...
Item {
    ...
    */
    ...
    Connections {
        ...
        function onHeightChanged() { flashScrollbar() }
        function onWidthChanged() { flashScrollbar() }
        ...
        function onDraggingChanged() {
            if (target.dragging) {
                visuals.flickableWasRecentlyDragged = true
            }
        }
    }
    property bool flickableWasRecentlyDragged: false
    ...
    MouseArea {
        ...
        Flow {
            ...
            anchors {
                ...
                leftMargin: visuals.flickableWasRecentlyDragged ? frontAligned ? units.gu(0) : 0
                                : (!isVertical || frontAligned) ? 0.0 : flowContainer.proximityThickness
                rightMargin: visuals.flickableWasRecentlyDragged ? rearAligned ? units.gu(0) : 0
                                : (!isVertical || rearAligned) ? 0.0 : flowContainer.proximityThickness
            ...
            // clip: true
            clip: visuals.flickableWasRecentlyDragged ? false : true
                ...
                MouseArea {
                    ...
                    function initDrag(isMouse) {
                        ...
                        if (isMouse) {
                            ...
                            // visuals.state = "thumb"
                            if (visuals.flickableWasRecentlyDragged) {
                                visuals.state = "touchthumb"
                            } else {
                                visuals.state = "thumb"
                            }
                        }
                    ...
                    anchors.fill: trough
                    anchors.leftMargin: visuals.flickableWasRecentlyDragged && visuals.isVertical ? -units.gu(1) : 0
                    anchors.rightMargin: visuals.flickableWasRecentlyDragged && visuals.isVertical ? -units.gu(1) : 0
                    ...
                    onPressed: {
                        ...
                        // } else if (visuals.veryLongContentItem && slider.containsTouch()) {
                                        ...
                                        || visuals.flickableWasRecentlyDragged) {
                            initDrag(false)
                        } else {
                            //propagate otherwise
    ...
    Binding {
        ...
        value: {
            if (!isScrollable && !alwaysOnScrollbars) {
                ...
                if (__initializedFlickable && __initializedFlickable.dragging) {
                    return 'touchthumb'
                } else if (proximityArea.containsMouseDevice || steppersMouseArea.pressed
    ...
    states: [
        ...
        State {
            ...
            PropertyChanges {
                target: visuals
                flickableWasRecentlyDragged: false
            }
        }
    ]
    transitions: [
        ...
        Transition {
            // from: 'thumb,steppers'
            from: 'thumb,steppers,touchthumb'
            to: 'indicator'
        ...
        Transition {
            ...
            SequentialAnimation {
                ...
                PropertyAction {
                    target: visuals
                    properties: "flickableWasRecentlyDragged"
                    value: false
                }
            }
        },
